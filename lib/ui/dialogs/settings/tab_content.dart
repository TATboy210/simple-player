...
//
// 职责：7 个 tab 的 IndexedStack + 每个 tab 的 200ms opacity 淡入淡出 + panelSectionBg 背板 + spMd padding。
...
/// [PendingSettingsState] 注入、`Tokens.panelSectionBg` 背板（D-02 结构色路由）、`Tokens.spMd` 内边距、
