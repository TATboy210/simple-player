...
enum GlassTier {
  ...
  static final ImageFilter _thinBlur = ui.ImageFilter.blur(
    sigmaX: Tokens.glassBlurThin,
    sigmaY: Tokens.glassBlurThin,
  );
  static final ImageFilter _normalBlur = ui.ImageFilter.blur(
    sigmaX: Tokens.glassBlur,
    sigmaY: Tokens.glassBlur,
  );
  static final ImageFilter _thickBlur = ui.ImageFilter.blur(
