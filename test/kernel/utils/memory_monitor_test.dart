/// Unit tests for [MetricSample] and [MemorySnapshot] data classes.
///
/// MemoryMonitor itself is a singleton with Timer/ProcessInfo dependencies,
/// so we only test the pure data classes here.
library;
